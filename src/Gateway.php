	...
	protected function set_form_fields() {
		...
		$this->form_fields         = array(
			...
			'manual_invoice_activation'   => array(
				...
				'type'        => 'checkbox',
				'default'     => 'no',
				'description' => __( 'For certain invoice payment methods (Walley/Klarna), you can activate the invoice at a later time, for example for pre-ordered products.<br><br><strong>Activation window:</strong><br>Walley: up to 90 days <br>Klarna: up to 28 days', 'paytrail-for-woocommerce' ),
			),
