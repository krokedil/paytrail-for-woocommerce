...
/** Product fixtures for the Integration suite, built through the WooCommerce CRUD layer. */
trait CanManageProducts {
	...
	/** Creates a simple product with no SKU, which the plugin falls back to the id for. */
	protected function haveProductWithoutSku( array $args = [] ): \WC_Product_Simple {
		return $this->haveSimpleProduct( array_merge( $args, [ 'sku' => '' ] ) );
	}
