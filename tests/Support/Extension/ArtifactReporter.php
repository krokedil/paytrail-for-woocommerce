 ...
 * downloadable from CI and the E2E suite runs against Paytrail's live test environment.
 *
...
class ArtifactReporter extends Extension
{
    ...
    /**
     * Chrome's console log. The provider redirect form reports its failures
     * here and nowhere else, which is usually the real reason a
